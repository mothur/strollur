...
[`strollur::read_qiime2()`](https://mothur.org/strollur/reference/read_qiime2.md)
...
```
    ...
    ## 2.5%-tile:       1  120    120      0        3     0   3933.43
    ## 25%-tile:        1  120    120      0        4     0  39325.25
    ## Median:          1  120    120      0        4     0  78649.50
    ## 75%-tile:        1  120    120      0        5     0 117973.75
    ## 97.5%-tile:      1  120    120      0        6     0 153365.57
    ## Maximum:         1  120    120      0        8     0 157298.00
    ## Mean:            1  120    120      0        4     0  78649.50
    ## 
...
- [`strollur::unpack_qiime2_artifact()`](https://mothur.org/strollur/reference/unpack_qiime2_artifact.md)
  unpacks qiime2 *qza* files and returns an artifact
- [`strollur::read_qiime2_feature_table()`](https://mothur.org/strollur/reference/read_qiime2_feature_table.md)
  reads a qiime2 *qza* file containing bin data
- [`strollur::read_qiime2_taxonomy()`](https://mothur.org/strollur/reference/read_qiime2_taxonomy.md)
  reads a qiime2 *qza* file containing containing taxonomy data
- [`strollur::read_qiime2_metadata()`](https://mothur.org/strollur/reference/read_qiime2_metadata.md)
...
fasta_artifact <-
  strollur::unpack_qiime2_artifact(qza = strollur_example("rep_seqs.qza"))
```
...
abundance <- strollur::read_qiime2_feature_table(strollur_example("table.qza"))
...
taxonomy <- strollur::read_qiime2_taxonomy(strollur_example("taxonomy.qza"))
...
tree_artifact <- strollur::unpack_qiime2_artifact(
  qza =
    strollur_example("rooted-tree.qza")
)
```
...
metadata <- strollur::read_qiime2_metadata(
  metadata =
