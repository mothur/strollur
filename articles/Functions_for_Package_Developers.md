...
#> 2.5%-tile:       1    4      4      0        4     0   2849.08
#> 25%-tile:        1  375    252      0        4     0  28490.75
#> Median:          1  375    253      0        4     0  56981.50
#> 75%-tile:        1  375    253      0        5     0  85472.25
#> 97.5%-tile:      1  375    254      4        6     4 111113.93
#> Maximum:         1  375    256      4        6     4 113963.00
#> Mean:            1  359    242      0        4     0  56981.64
#> 
#> Number of unique seqs: 2425 
#> Total number of seqs: 113963 
#> 
...
#>             starts ends nbases ambigs polymers numns   numseqs
#> Minimum:         1  375    249      0        3     0      1.00
#> 2.5%-tile:       1  375    252      0        4     0   2846.35
#> 25%-tile:        1  375    252      0        4     0  28463.50
#> Median:          1  375    253      0        4     0  56927.00
#> 75%-tile:        1  375    253      0        5     0  85390.50
#> 97.5%-tile:      1  375    254      0        6     0 111007.65
#> Maximum:         1  375    256      0        6     0 113854.00
#> Mean:            1  375    252      0        4     0  56927.14
#> 
#> scrap_summary:
...
#>             starts ends nbases ambigs polymers numns   numseqs
#> Minimum:         1  375    249      0        3     0      1.00
#> 2.5%-tile:       1  375    252      0        4     0   2528.60
#> 25%-tile:        1  375    252      0        4     0  25286.00
#> Median:          1  375    253      0        4     0  50572.00
#> 75%-tile:        1  375    253      0        5     0  75858.00
#> 97.5%-tile:      1  375    254      0        6     0  98615.40
#> Maximum:         1  375    256      0        6     0 101144.00
#> Mean:            1  375    252      0        4     0  50572.14
#> 
#> scrap_summary:
#>        type               trash_code unique total
#> 1  sequence F3D0_exclusive_sequences    101   109
...
#>             starts ends nbases ambigs polymers numns  numseqs
#> Minimum:         1  375    249      0        3     0     1.00
#> 2.5%-tile:       1  375    251      0        4     0  1979.90
#> 25%-tile:        1  375    252      0        4     0 19799.00
#> Median:          1  375    253      0        4     0 39598.00
#> 75%-tile:        1  375    253      0        5     0 59397.00
#> 97.5%-tile:      1  375    254      0        6     0 77216.10
#> Maximum:         1  375    256      0        6     0 79196.00
#> Mean:            1  375    252      0        4     0 39598.14
#> 
#> scrap_summary:
#>         type               trash_code unique total
#> 1   sequence F3D0_exclusive_sequences    101   109
...
#>             starts ends nbases ambigs polymers numns  numseqs
#> Minimum:         1  375    249      0        3     0     1.00
#> 2.5%-tile:       1  375    251      0        4     0  1935.30
#> 25%-tile:        1  375    252      0        4     0 19353.00
#> Median:          1  375    253      0        4     0 38706.00
#> 75%-tile:        1  375    253      0        5     0 58059.00
#> 97.5%-tile:      1  375    254      0        6     0 75476.70
#> Maximum:         1  375    256      0        6     0 77412.00
#> Mean:            1  375    252      0        4     0 38706.14
#> 
#> scrap_summary:
#>         type               trash_code unique total
#> 1   sequence F3D0_exclusive_sequences    101   109
...
#>             starts ends nbases ambigs polymers numns  numseqs
#> Minimum:         1  375    249      0        3     0     1.00
#> 2.5%-tile:       1  375    251      0        4     0  1892.25
#> 25%-tile:        1  375    252      0        4     0 18922.50
#> Median:          1  375    252      0        4     0 37845.00
#> 75%-tile:        1  375    253      0        5     0 56767.50
#> 97.5%-tile:      1  375    254      0        6     0 73797.75
#> Maximum:         1  375    256      0        6     0 75690.00
#> Mean:            1  375    252      0        4     0 37845.14
#> 
#> scrap_summary:
#>         type                  trash_code unique total
#> 1   sequence    F3D0_exclusive_sequences    101   109
