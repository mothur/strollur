...
#>   ..$ vendor           : chr [1:2] "NA" "NA"
#>   ..$ name             : chr [1:2] "R phylotypr package" "silva.bacteria.fasta"
#>   ..$ version          : chr [1:2] "NA" "NA"
#>   ..$ usage            : chr [1:2] "NA" "NA"
#>   ..$ note             : chr [1:2] "NA" "NA"
#>   ..$ method_url       : chr [1:2] "NA" "NA"
#>   ..$ documentation_url: chr [1:2] "NA" "NA"
#>   ..$ parameter        : chr [1:2] "NA" "NA"
#>   ..$ citation         : chr [1:2] "NA" "NA"
#>   ..$ creation_date    : chr [1:2] "2026-05-21" "2026-05-21"
