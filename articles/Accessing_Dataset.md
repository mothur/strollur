...
#>                                 vendor                 name version
#> 1 Schloss Lab - University of Michigan  R phylotypr package   0.1.1
#> 2                                SILVA silva.bacteria.fasta  1.38.1
#>                         usage                                     note
#> 1 classification of sequences     classification using Bayesian method
#> 2      alignment of sequences alignment reference trimmed to V4 region
#>                 method_url                              documentation_url
#> 1 doi:10.1128/mra.01144-24                  https://mothur.org/phylotypr/
#> 2                       NA https://mothur.org/wiki/silva_reference_files/
#>                                          parameter
#> 1 kmer_size=8,num_bootstraps=100,min_confidence=80
#> 2                                               NA
#>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 citation
