...
RCPP_MODULE(Dataset) {
    ...
    .method("assign_otu_taxonomy", &Dataset::assignOtuTaxonomy, "Assign otu classification")
    ...
    .method("get_otu_taxonomy_report", &Dataset::getOtuTaxonomyReport, "Get data.frame containing otu taxonomy data")
