...
names(data = miseq, type = "bins", samples = c("F3D0"), distinct = TRUE) |> head(n = 5)

# To get the names of the "otu" bins that include sequences from 'F3D0'
names(data = miseq, type = "bins", samples = c("F3D0"), distinct = FALSE) |> head(n = 5)
...
abundance(data = miseq, type = "bins", bin_type = "otu", by_sample = TRUE) |> head(n = 5)
...
abundance(data = miseq, type = "bins", bin_type = "asv", by_sample = TRUE) |> head(n = 5)
...
report(data = miseq, type = "bin_taxonomy", bin_type = "phylotype") |> head(n = 7)
