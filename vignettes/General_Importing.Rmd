...
Now that we have added our custom contigs assembly report, let's learn how to add reports not tied to sequence names. We can add metadata to our data set by setting the type = "report", report_type = "metadata".
...
data$add(sample_tree, type = "sample_tree")
data$add(sequence_tree, type = "sequence_tree")

#| fig.alt: >
#|   Plot of Miseq_SOP's sample relationship tree
old_par <- par(bg = "white")
ape::plot.phylo(data$report(type = "sample_tree"),
  no.margin = TRUE,
