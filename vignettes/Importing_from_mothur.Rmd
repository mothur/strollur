...
sample_table <- read_mothur_count(
  filename = rdataset_example("final.count_table.gz")
)
```
...
asv_data <- read_mothur_list(list = rdataset_example("final.asv.list.gz"))
phylotype_data <- read_mothur_list(list = rdataset_example("final.tx.list.gz"))
```
