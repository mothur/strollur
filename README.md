...
- `strollur::add()` adds sequences, reports, metadata, and resource
  references
- `strollur::assign()` assigns abundances, classifications, bins,
  samples and treatments and more
- `strollur::names()` gets the names of sequences, bins, samples,
  treatments and reports
- `strollur::count()` gets the number of sequences, bins, samples and
  treatments
- `strollur::abundance()` gets the abundances for sequences, bins,
  samples, and treatments
- `strollur::report()` gets
...
- `strollur::summary()` summarizes sequences, your custom reports, and
  scrapped data
