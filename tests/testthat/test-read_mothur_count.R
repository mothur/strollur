...
test_that("test read_mothur_count compressed with samples", {
  ...
  expect_equal(c("sequence_name", "sample", "abundance"), colnames(results))
  ...
  expect_equal(first_ten, results$sequence_name[1:10])
...
test_that("test read_mothur_count uncompressed NO samples", {
  ...
  expect_equal(c("sequence_name", "abundance"), colnames(results))
  ...
  expect_equal(names, results$sequence_name)
})
