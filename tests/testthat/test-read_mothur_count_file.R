...
test_that("test read_mothur_count_file compressed with groups", {
    ...
    first_ten <- c("M00967_43_000000000-A3JHG_1_1101_10386_25574",
    ...
    first_ten_groups <- c("F3D2", "F3D146", "F3D150", "F3D145",
...
test_that("test read_mothur_count_file uncompressed NO groups", {
    ...
    names <- c("chimera1", "non_chimera2ParentB", "chimera1ParentB",
