...
#> [1] "/tmp/RtmpQ9YJsl/file1a7b114669f2.otu.cons.taxonomy"      
#> [2] "/tmp/RtmpQ9YJsl/file1a7b114669f2.asv.cons.taxonomy"      
#> [3] "/tmp/RtmpQ9YJsl/file1a7b114669f2.phylotype.cons.taxonomy"
```
