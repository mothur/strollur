...
#> [1] "/tmp/RtmpQaaSxa/file1b5e1d4bd0df.otu.cons.taxonomy"      
#> [2] "/tmp/RtmpQaaSxa/file1b5e1d4bd0df.asv.cons.taxonomy"      
#> [3] "/tmp/RtmpQaaSxa/file1b5e1d4bd0df.phylotype.cons.taxonomy"
```
