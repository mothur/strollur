...
- [`load_dataset()`](https://mothur.org/strollur/reference/load_dataset.md)
  ...
  Load a [strollur](https://mothur.org/strollur/reference/strollur.html)
  object from a file.

- [`export_dataset()`](https://mothur.org/strollur/reference/export_dataset.md)
  :

  Create a human readable table containing all data from a
...
- [`write_mothur()`](https://mothur.org/strollur/reference/write_mothur.md)
  ...
  types](https://mothur.org/wiki/tags/#file_types) from your
  [strollur](https://mothur.org/strollur/reference/strollur.html) object
  for use with mothur.
