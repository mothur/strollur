...
public:
    ...
    Rcpp::List exportBinTable(const AbundTable& count);
...
private:
    ...
    Rcpp::DataFrame getAbundanceTable(const AbundTable& count) const;
...
public:
    ...
    Rcpp::DataFrame getBinAbundances(const string& bin_type = "otu",
